...
public final class Home extends javax.swing.JFrame {
    ...
    private final Home_Dashboard homeDashboard = new Home_Dashboard();
    private final Home_Product homeProduct = new Home_Product();
    private final Home_Sale_Orders homeSaleOrders = new Home_Sale_Orders();
    ...
    private void initComponents() {
        ...
        lbl_AccountRole = new javax.swing.JLabel();
        ...
        lbl_AccountName.setBackground(new java.awt.Color(255, 255, 255));
        lbl_AccountName.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ...
        lbl_AccountName.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);

        lbl_AccountRole.setBackground(new java.awt.Color(255, 255, 255));
        lbl_AccountRole.setForeground(new java.awt.Color(255, 255, 255));
        lbl_AccountRole.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_AccountRole.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        ...
        pn_Home_StaffLayout.setHorizontalGroup(
            ...
            .addComponent(lbl_AccountName, javax.swing.GroupLayout.DEFAULT_SIZE, 383, Short.MAX_VALUE)
            .addComponent(lbl_AccountRole, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        pn_Home_StaffLayout.setVerticalGroup(
            pn_Home_StaffLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pn_Home_StaffLayout.createSequentialGroup()
                .addComponent(lbl_AccountName, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lbl_AccountRole, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE))
        );
    ...
    private void pn_Home_ReportMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pn_Home_ReportMouseClicked
        levanan.changePanel(MainPanel, homeReport);
    ...
    private void pn_Home_HistoryMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pn_Home_HistoryMouseClicked
        levanan.changePanel(MainPanel, homeHistory);
    ...
    private void pn_Home_ProductMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pn_Home_ProductMouseClicked
        levanan.changePanel(MainPanel, homeProduct);
    ...
    private void pn_Home_DashboardMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pn_Home_DashboardMouseClicked
        levanan.changePanel(MainPanel, homeDashboard);
    ...
    private void pn_Home_SaleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pn_Home_SaleMouseClicked
        levanan.changePanel(MainPanel, homeSaleOrders);
    ...
    private javax.swing.JLabel lbl_AccountRole;
